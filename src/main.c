...
int main (int argc, char *argv[])
  ...
  //initialisation du gestionnaire d'�v�nements
  SDL_Event event;

  //initialisation de la police d'�criture
  ...
  //initialisation des positions des premi�res images
  ...
  //chargement des premi�res images et de la police d'ecriture
  ...
  //permet de laisser une touche enfonc�e
  ...
  while (continuer)
    ...
    while (continuer && (tableau==1))
      ...
      //d�termine le nombre de coeurs a afficher a l'ecran
